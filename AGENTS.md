...
4. Current Gate A runtime authority:
 ...
 (`5a782f6` INSTALLED CI **35321447455**; GATE A P2 R7 **PASS / COMPLETE 13/13**; R8-C1 attempt-05 **R8_INVALID POST_END_OBSERVATION** frozen; attempts 01–04 frozen; C2–P2 NOT RUN; historical CI **35304122983** / **35305368742** FAIL frozen; do not silent-retry CI or C1 attempts 01–05; do not start R8-C2 or R9; Production BLOCKED) and
