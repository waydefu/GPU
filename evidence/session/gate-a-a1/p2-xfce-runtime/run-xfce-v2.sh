#!/usr/bin/env bash
# XFCE baseline runner V2 — product bfb5769 (PGA-GAP-1 fix), XFCE-FREEZE-V2.
...
XFCE=$ROOT/src/f8-ahb-gatea-r7-p1-arm/tests/xfce2
...
EXPECT_MANIFEST_SHA=44e524f1685e5e7beb632a4c981cc09967f7f92402d3eb90940918c30bb042a0
...
if [ "$VALIDATE_ONLY" = 1 ]; then
  echo "XFCE_RUNNER_V2_VALIDATE_ONLY variant=$VARIANT manifest=$GOT"
  exit 0
fi
