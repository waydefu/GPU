#!/usr/bin/env bash
# R8 one-cell runner b984ded-v9 — cell_d sync-roundtrip fix rebind (+v6 GAP-8, +v5 D-17, +v4 ordering, +v3 F1) (+v5 D-17, +v4 ordering, +v3 F1).
#
...
MANIFEST=/root/projects/GPU加速/evidence/session/gate-a-a1/p2-r8-runtime/runtime-b984ded/r8-runtime-tooling-manifest-v9.json
...
EXPECT_FIXTURE_SHA=2f3db1bb129f47dcf5bd21f9be89fd8e2c7fd5785c8df706f9f1fd50b6afc70d
...
if [ "$VALIDATE_ONLY" = 1 ]; then
  echo "R8_LIVE_RUNNER_B984DED_V9_VALIDATE_ONLY $CELL_ID"
  exit 0
fi
