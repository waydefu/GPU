#!/usr/bin/env bash
# R8 one-cell runner b984ded-v11 — identical-event dedup rebind (+v6 GAP-8, +v5 D-17, +v4 ordering, +v3 F1) (+v5 D-17, +v4 ordering, +v3 F1).
#
...
MANIFEST=/root/projects/GPU加速/evidence/session/gate-a-a1/p2-r8-runtime/runtime-b984ded/r8-runtime-tooling-manifest-v11.json
...
if [ "$VALIDATE_ONLY" = 1 ]; then
  echo "R8_LIVE_RUNNER_B984DED_V11_VALIDATE_ONLY $CELL_ID"
  exit 0
fi
