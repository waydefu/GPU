#!/usr/bin/env bash
# R8 one-cell runner b984ded-v10 — PictOpOver composite fix rebind (+v6 GAP-8, +v5 D-17, +v4 ordering, +v3 F1) (+v5 D-17, +v4 ordering, +v3 F1).
#
...
MANIFEST=/root/projects/GPU加速/evidence/session/gate-a-a1/p2-r8-runtime/runtime-b984ded/r8-runtime-tooling-manifest-v10.json
...
EXPECT_FIXTURE_SHA=2b0c97f87a1bfbec34b580f552af287f343330d82b933ed23aa121a57717c5a6
...
if [ "$VALIDATE_ONLY" = 1 ]; then
  echo "R8_LIVE_RUNNER_B984DED_V10_VALIDATE_ONLY $CELL_ID"
  exit 0
fi
