...
MANIFEST=/root/projects/GPU加速/evidence/session/gate-a-a1/p2-r8-runtime/runtime-b984ded/r8-runtime-tooling-manifest-v4.json
...
EXPECT_FIXTURE_SHA=ad93f2ba6adcaae53dbb750b9bdc928d32b1932c3e86ea1b4d2121a5c96f12de
...
if [ "$VALIDATE_ONLY" = 1 ]; then
  echo "R8_LIVE_RUNNER_B984DED_V4_VALIDATE_ONLY $CELL_ID"
  exit 0
fi
