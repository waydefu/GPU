#!/usr/bin/env bash
# bfb5769 (PGA-GAP-1) copy of run-r8-one-cell-dc94485.sh. Delta: the seven artifact
# constants and the manifest path. Same judge, spec, orchestration, fixture, cells.
...
MANIFEST=/root/projects/GPU加速/evidence/session/gate-a-a1/p2-r8-runtime/runtime-bfb5769/r8-runtime-tooling-manifest-bfb5769.json
...
EXPECT_BUILD_ID=890db760a77a7d22945b9640705f70d025b5d518
...
if [ "$VALIDATE_ONLY" = 1 ]; then
  echo "R8_LIVE_RUNNER_BFB5769_V1_VALIDATE_ONLY $CELL_ID"
  exit 0
fi
