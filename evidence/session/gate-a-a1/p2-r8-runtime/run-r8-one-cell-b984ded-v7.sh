#!/usr/bin/env bash
# R8 one-cell runner b984ded-v7 — C3 two-legal-trace rebind (+v6 GAP-8, +v5 D-17, +v4 ordering, +v3 F1) (+v5 D-17, +v4 ordering, +v3 F1).
#
...
MANIFEST=/root/projects/GPU加速/evidence/session/gate-a-a1/p2-r8-runtime/runtime-b984ded/r8-runtime-tooling-manifest-v7.json
...
EXPECT_FIXTURE_SHA=a4c8099fd748f13b2ed0f354847310f9916087cd8b5e06aaa0da0966a119e4ac
...
if [ "$VALIDATE_ONLY" = 1 ]; then
  echo "R8_LIVE_RUNNER_B984DED_V7_VALIDATE_ONLY $CELL_ID"
  exit 0
fi
