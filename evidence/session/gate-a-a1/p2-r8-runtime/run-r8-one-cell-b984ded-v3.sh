...
MANIFEST=/root/projects/GPU加速/evidence/session/gate-a-a1/p2-r8-runtime/runtime-b984ded/r8-runtime-tooling-manifest-v3.json
...
if [ "$VALIDATE_ONLY" = 1 ]; then
  echo "R8_LIVE_RUNNER_B984DED_V3_VALIDATE_ONLY $CELL_ID"
  exit 0
fi
