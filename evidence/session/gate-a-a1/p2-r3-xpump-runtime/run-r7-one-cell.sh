#!/usr/bin/env bash
# One mandatory R7 injected-failure cell on installed 7549e36. Experimental :3 only.
# Not B-2. Not repair-validation. Not R8+. No source mutation. No retry.
# Usage: SERIAL=... ROOT=.../runtime-7549e36/r7-qualification-01 \
#        CELL_ID=r7-04 FAULT=fbo-incomplete FIXTURE=direct WAIT_S=12 \
#        bash run-r7-one-cell.sh
set -euo pipefail
...
EXPECT_VERSION=1.03.01-7549e36-16.09.26
: "${SERIAL:?}"
: "${ROOT:?}"
: "${CELL_ID:?}"
: "${FAULT:?}"
