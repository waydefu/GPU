#!/usr/bin/env bash
# XFCE-NOTEL-01 series, deviation 1 (freeze section 10): runner V5b (R8 not armed), new OUT. Otherwise series-notel.sh.
...
RUNNER=$HERE/run-xfce-v5b-notel.sh   # deviation 1 (freeze section 10)
NOTEL=/root/projects/GPU加速/src/f8-ahb-exa-async/tests/xfce_notel
RTT=/root/build/xfce-v6/x_rtt2.glibc
: "${SERIAL:?}"
OUT=${OUT:-$HERE/runtime-f592241-notel-b}
